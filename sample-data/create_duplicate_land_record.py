...
output_path = Path(__file__).resolve().parent / "synthetic_land_record_duplicate.pdf"
...
centered("DUPLICATE TEST DOCUMENT", 375, font(24))
...
draw.text((180, 2260), "This document is intentionally created to test duplicate detection and area mismatch warnings.", fill=(75, 75, 68), font=small_font)
